        ...
        files?.map((file) => {
          ...
          if (filetype == "python") {
            ...
            reader.onload = () => {
              ...
              if (base64data) {
                axios.post('http://localhost:8000/upload', { 'filename': file.name, 'content': base64data }).then((res) => setMicroserviceData(Object.assign(JSON.parse(res.data), { 'parent_file': file.name })))
              }
            };
          }
