...
export default function ViewMicroservice() {
    ...
    useEffect(() => {
        // Once files have been read, set the microservice data
        setMicroserviceData({ microservices: microserviceList })
        setLoading(false);
    }, [microserviceList])

    // Drag and drop snippet sourced from Atlassian beautiful-dnd example
    ...
    async function readFiles() {
        // Maps over uploaded microservice files and uploads them
        appFiles?.map(file => {
